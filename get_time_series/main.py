...
def compute_time_series(save_path_name_description,save_path_name_data,params,dt,T,d,N=N):
    # =============================================================================
    ...
    explore_param_space_time_evolution_(params, save_path_name_data,dt,T,d,N=N)
