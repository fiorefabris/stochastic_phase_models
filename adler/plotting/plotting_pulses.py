...
######## Getting data information
    ...
    dt_quart = [6,8.33]; IPI_quart = [8,18.67];pulse_rate_quart =[0.02, 0.06] #list(get_dyncode_pulse_rate_st(dyncode_file_name)) #mean, sigma
...
######## Getting data information
    ...
    dt_quart = [6,8.33]; IPI_quart = [8,18.67];pulse_rate_quart = [0.02, 0.06] #[0.0067, 0.02]
    #list(get_dyncode_pulse_rate_st(dyncode_file_name)) #mean, sigma
